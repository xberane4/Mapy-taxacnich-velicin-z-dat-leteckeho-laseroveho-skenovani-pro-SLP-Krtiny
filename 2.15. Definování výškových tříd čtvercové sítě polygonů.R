...
# tabulce pixelů na základě kombinace dřevinné skupiny
# ("skupina") a hodnoty výškové proxy veličiny z_p95. Pro každou
# skupinu jsou ve skriptu ručně definovány tři intervaly, podle
# nichž je následně každému pixelu přiřazen odpovídající
# kategoriální label. Výstupem je rozšířená tabulka určená
# pro navazující plošnou aplikaci regresních modelů.
# ============================================================
...
# 0) CESTY K SOUBORŮM
# ------------------------------------------------------------
INPUT_PATH  <- "C:/Users/Martin/Desktop/LDF/_ING/Dip_Les/R_test/Vystupy_GIS/TAB_GRID_FIN_FIN.csv"
OUTPUT_PATH <- "C:/Users/Martin/Desktop/LDF/_ING/Dip_Les/R_true/LLM_X20/Hclass_TAB_GRID_FIN_FIN_X20.csv"
...
# ------------------------------------------------------------
# 8) VAROVÁNÍ PRO NEPŘIŘAZENÉ ZÁZNAMY
# ------------------------------------------------------------
